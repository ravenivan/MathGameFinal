...
public class MathGame {
    ...
    private void determineWinner() {
        if (currentPlayer == player1) {
            winner = player2;
            player1.resetWinSteak();
            player3.resetWinSteak();
            player2.incrementWinSteak();
            player2.setHighestWinStreak();
        } else if (currentPlayer == player3){
            winner = player1;
            player2.resetWinSteak();
            player3.resetWinSteak();
            player1.incrementWinSteak();
            player1.setHighestWinStreak();
        } else {
            winner = player3;
            player2.resetWinSteak();
            player1.resetWinSteak();
            player3.incrementWinSteak();
            player3.setHighestWinStreak();
        }
